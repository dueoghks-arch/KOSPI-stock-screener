...
def screen_krx_stocks():
    ...
    for ticker in all_close_data.columns:
        try:
            ...
            # [조건 2] 최저가 부근 바닥 다지기 비율 검증 (기간 조건 완전 해제 - 값만 기록)
    ...
    if results:
        ...
        <ul>
            ...
            <li><b>바닥 매집 조건:</b> 제한 없음 (돌파 탄력성 극대화)</li>
            <li><b>박스권 돌파 마진:</b> 상단 돌파 후 +50% 이내 과열 구간까지 포함</li>
        ...
        <p><b>시장 범위:</b> KOSPI 전체 및 KOSDAQ 상위 50% 선별</p>
        <hr>
        <p>현재 완화된 기준(매집 기간 제한 없음, 돌파 마진 +50% 이내)을 만족하는 국장 장기 박스권 돌파형 종목이 포착되지 않았습니다.</p>
        """
